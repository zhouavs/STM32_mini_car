...
static errno_t receive_DMA(Device_SPI *pd, uint8_t *data, uint32_t len);
static errno_t transmit_DMA(Device_SPI *pd, uint8_t *data, uint32_t len);
static errno_t abort_receive(Device_SPI *pd);
static errno_t abort_transmit(Device_SPI *pd);
