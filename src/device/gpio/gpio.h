...
typedef enum Device_GPIO_name {
  DEVICE_LED_1_OUT, DEVICE_LED_2_OUT, DEVICE_LED_3_OUT, DEVICE_LED_4_OUT,
  DEVICE_KEY_1_IN, DEVICE_KEY_2_IN, DEVICE_KEY_3_IN, DEVICE_KEY_4_IN,
  DEVICE_W25Q64_CS,
  ...
  DEVICE_IRDA_IN, DEVICE_DHT11_IN, DEVICE_ULTRASONIC_TRIG, DEVICE_ULTRASONIC_ECHO,
  DEVICE_GPIO_COUNT,
} Device_GPIO_name;
